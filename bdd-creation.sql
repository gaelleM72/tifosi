...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 30 oct. 2024 à 12:31
...
ALTER TABLE `contient`
  ...
  ADD CONSTRAINT `contient_ibfk_3` FOREIGN KEY (`id_marque`) REFERENCES `marque` (`id_marque`);

--
-- Contraintes pour la table `est constitue`
--
ALTER TABLE `est constitue`
  ADD CONSTRAINT `est constitue_ibfk_1` FOREIGN KEY (`id_focaccia`) REFERENCES `focaccia` (`id_focaccia`),
  ADD CONSTRAINT `est constitue_ibfk_2` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`);
